...
class LLMEnsemble:
    ...
    def select_model(self, generation: int, num_generations_without_improvement: int = 0) -> ModelTier:
        """
    ...
    def extract_code(self, llm_response: str) -> str:
        ...
        clean_code = re.sub(r'^(Here is|The|Improved).*?:\s*', '', clean_code, flags=re.IGNORECASE)
    ...
    @staticmethod
    def create_single_model_ensemble(model_id: str = "google/gemma-2b-it") -> 'LLMEnsemble':
        """
